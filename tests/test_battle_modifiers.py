...
class TestMove(unittest.TestCase):
    ...
    def test_sets_item_to_unknown_if_the_pokemon_has_choice_item_but_two_different_moves_are_used(
        self,
    ):
        self.battle.opponent.active.can_have_choice_item = True
    ...
    def test_does_not_set_can_have_life_orb_to_false_if_pokemon_could_have_sheerforce(
        self,
    ):
    ...
    def test_does_not_set_can_have_life_orb_to_false_if_pokemon_could_have_magic_guard(
        self,
    ):
...
class TestCheckHeavyDutyBoots(unittest.TestCase):
    ...
    def test_basic_case_of_switching_in_and_taking_damage_sets_can_have_heavydutyboots_to_false(
        self,
    ):
        self.battle.opponent.side_conditions[constants.STEALTH_ROCK] = 1
        messages = [
...
class TestCheckChoiceItem(unittest.TestCase):
    ...
    def test_does_guess_choiceband_when_bot_shellsmashes_but_white_herb_clears_negative_boosts(
        self,
    ):
    ...
    def test_sets_can_not_have_band_or_specs_to_true_when_damage_is_too_low(self):
        ...
        self.assertFalse(
            self.battle.opponent.active.can_not_have_specs
    ...
    def test_sets_can_not_have_specs_when_attack_is_special(self):
        ...
        self.assertFalse(
            self.battle.opponent.active.can_not_have_band
        )  # should remain untouched

    def test_does_not_set_can_not_have_band_or_specs_to_true_when_pikachu_can_have_lightball(
        self,
    ):
        self.battle.user.active = Pokemon("Metagross", 100)
        self.battle.user.active.set_spread("adamant", "0,252,4,0,0,252")

        ...
        self.state_json = {
            "user": {
                "active": {
                    ...
                    "volatileStatus": [],
                    "moves": [
                        {"id": "calmmind", "disabled": False, "current_pp": 31},
                        {"id": "hydropump", "disabled": False, "current_pp": 7},
                        {"id": "secretsword", "disabled": False, "current_pp": 15},
                        {"id": "taunt", "disabled": False, "current_pp": 32},
                    ],
                ...
                "reserve": {
                    "landorustherian": {
                        ...
                        "moves": [
                            ...
                            {"id": "explosion", "disabled": False, "current_pp": 8},
                    ...
                    "tornadustherian": {
                        ...
                        "volatileStatus": [],
                        "moves": [
                            {"id": "hurricane", "disabled": False, "current_pp": 16},
                            {"id": "defog", "disabled": False, "current_pp": 24},
                    ...
                    "diancie": {
                        ...
                        "moves": [
                            ...
                            {"id": "diamondstorm", "disabled": False, "current_pp": 8},
                            {"id": "substitute", "disabled": False, "current_pp": 16},
                            {"id": "endeavor", "disabled": False, "current_pp": 8},
                        ],
                        "types": ["rock", "fairy"],
                        "canMegaEvo": False,
                        "nature": "serious",
                    ...
                    "victini": {
                        ...
                        "volatileStatus": [],
                        "moves": [
                            {"id": "vcreate", "disabled": False, "current_pp": 8},
                            {"id": "boltstrike", "disabled": False, "current_pp": 8},
                            {"id": "uturn", "disabled": False, "current_pp": 32},
                            {"id": "finalgambit", "disabled": False, "current_pp": 8},
                        ],
                        "types": ["psychic", "fire"],
                        "canMegaEvo": False,
                        "nature": "serious",
            ...
            "opponent": {
                "active": {
                    ...
                    "attack_boost": 0,
                    "defense_boost": 0,
                    "special_attack_boost": 6,
                    "special_defense_boost": 0,
                    "speed_boost": 0,
                    "status": None,
                    "volatileStatus": [],
                    "moves": [{"id": "tailglow", "disabled": False, "current_pp": 32}],
                    "types": ["water"],
                    "canMegaEvo": False,
                    "nature": "serious",
                    "evs": (85, 85, 85, 85, 85, 85),

...
class TestGetSmogonStatsFileName(unittest.TestCase):
    ...
    def test_returns_single_digit_month_properly(self):
        ...
        self.assertEqual(
            "https://www.smogon.com/stats/2019-04/chaos/gen7ou-0.json", file_name
        )
    ...
    def test_works_with_double_digit_month(self):
        ...
        self.assertEqual(
            "https://www.smogon.com/stats/2019-09/chaos/gen7ou-0.json", file_name
        )
    ...
    def test_returns_previous_year_properly(self):
        ...
        self.assertEqual(
            "https://www.smogon.com/stats/2018-11/chaos/gen7ou-0.json", file_name
        )

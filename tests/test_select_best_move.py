...
class TestGetAllOptions(unittest.TestCase):
    ...
    def test_opponent_pokemon_with_phantomforce_volatilestatus_must_use_phantomforce(
        self,
    ):
        self.state.user.active.moves = [
            {constants.ID: "tackle", constants.DISABLED: False},
    ...
    def test_returns_only_switches_for_user_and_nothing_for_opponent_when_user_active_is_dead(
        self,
    ):
        expected_options = (
            [
    ...
    def test_returns_nothing_for_user_when_opponent_active_is_dead(self):
        ...
        expected_user_options = [constants.DO_NOTHING_MOVE]
